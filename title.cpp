...
#define	TITLE_LOGO_POS_Y		(20)		// タイトルロゴの位置(Y座標)
#define	TITLE_LOGO_WIDTH		(740)		// タイトルロゴの幅
#define	TITLE_LOGO_HEIGHT		(340)		// タイトルロゴの高さ

#define	START_POS_X				(150)		// スタートボタンの位置(X座標)
#define	START_POS_Y				(350)		// スタートボタンの位置(Y座標)
