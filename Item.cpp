...
{
	"data/MODEL/banana.x",		// コイン
	"data/MODEL/item001.x",		// ライフ
	"data/MODEL/item002.x"		// タイマー
};
const char *c_aTextureNameItem[ITEMTYPE_MAX] =
{
	"data/TEXTURE/Bannana_v01.jpg",		// コイン
	"data/TEXTURE/Bannana_v01.jpg",		// ライフ
	"data/TEXTURE/Bannana_v01.jpg"		// タイマー
};
...
HRESULT InitItem(void)
{
	...
	for (int nCntItemType = 0; nCntItemType < ITEMTYPE_MAX; nCntItemType++)
	{
		...
		D3DXCreateTextureFromFile(pDevice,									// デバイスへのポインタ
			c_aTextureNameItem[nCntItemType],						// ファイルの名前
